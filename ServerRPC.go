...
func (p *RPC) StartMaple(req StartMapleReq, res *bool) error {
	...
	case "Juice":
		//run juice
		Juice(req.JuiceExe, req.MapleNum, req.InterPrefix, req.ResultName, req.DeleteInter)
	case "MapleJuice":
		//run merge
		mapleJuice(req.MapleExe, req.JuiceExe, req.MapleNum, req.InterPrefix, req.DataDir2, req.ResultName, req.DeleteInter)
	}
	*res = true
	return nil
}
