 ...
 */
func (c *Client) startMaple(workType string, mapleExe string, juiceExe string, mapleNum int, interPrefix string, dataDir2 string, resultName string, deleteInter string, nodeIP string) error {
	var res bool
	client, _ := c.Connect(nodeIP)
